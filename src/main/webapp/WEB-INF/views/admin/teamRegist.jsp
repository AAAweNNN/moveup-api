                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form:form modelAttribute="teamForm" id="userForm" enctype="multipart/form-data"
                                           class="form-horizontal form-label-left"
                                           action="${pageContext.request.contextPath}/admin/team/regist/">
                                    <div class="item form-group">
                                        <div>
                                            ...
                                            <div class="col-md-1 col-sm-6 col-xs-12">
                                                <form:select path="type" type="text" id="type" name="type"
                                                             required="required"
                                        ...
                                        <div>
                                            ...
                                            <div class="col-md-1 col-sm-6 col-xs-12">
                                                <form:input value="0" path="sortScore" type="number" id="sortScore"
                                                            name="sortScore" required="required"
                                                            class="form-control col-md-7 col-xs-12"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <form:input path="excerpt" type="text" id="excerpt" name="excerpt"
                                                        required="required"
                                                        class="form-control col-md-7 col-xs-12"/>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <label class=" col-md-5 col-sm-3 col-xs-12"
                                                       style="text-align: left;padding:0 5px;" for="">TOP画像<span
                                                        class="required"></span>
                                                </label>
                                                <label class=" col-md-7 col-sm-3 col-xs-12" style="text-align: right">解像度:
                                                    500 X 500</label>
                                            </div>
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="item form-group" style="margin-top: 30px;">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <label class=" col-md-5 col-sm-3 col-xs-12"
                                                       style="text-align: left;padding:0 5px;" for="">FOOT画像<span
                                                        class="required"></span>
                                                </label>
                                                <label class=" col-md-7 col-sm-3 col-xs-12" style="text-align: right">解像度:
                                                    500 X 500</label>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <form:input path="detail" id="detail" required="" name="detail"
                                                        type="hidden"
                                                        class="form-control col-md-7 col-xs-12"
                                                        cssStyle="height: 200px;"></form:input>
                                            <div class="x_content">
                                                <div class="btn-toolbar editor" data-role="editor-toolbar"
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <a class="btn" data-edit="tel" title="Telephone"><i
                                    ...
                                    <div class="item form-group">
                                        <div>
                                            ...
                                            <div class="col-md-2 col-sm-6 col-xs-12">
                                                <form:input path="publishStart" type="text" id="publishStart"
                                                            name="publishStart"
                                                            data-date-format="yyyy-mm-dd hh:ii"
                                                            class="form-control col-md-7 col-xs-12"/>
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="col-md-2 col-sm-6 col-xs-12">
                                                <form:input path="publishEnd" type="text" id="publishEnd"
                                                            name="publishEnd"
                                                            data-date-format="yyyy-mm-dd hh:ii"
                                                            class="form-control col-md-7 col-xs-12"/>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <a class="btn btn-primary" href="/admin/team/list/" style="width: 100px;">キャンセル</a>
...
<script>
    ...
    $('#picFile1').fileinput({
        ...
        "minImageHeight": 500,
        "maxImageHeight": 500
        <%--<c:if test="${teamForm.picUrl1 != null && teamForm.picUrl1 != ''}">--%>
        <%--, 'uploadUrl': null, 'initialPreview': [--%>
        <%--"<img src='${teamForm.picUrl1}' class='file-preview-image kv-preview-data' stype='width:auto;height:auto;max-width:100%;max-height:100%;' alt='Desert' title='Desert'>"--%>
        <%--]--%>
        <%--</c:if>--%>
    });
    $('#picFile2').fileinput({
        ...
        "minImageHeight": 500,
        "maxImageHeight": 500
        <%--<c:if test="${teamForm.picUrl2 != null && teamForm.picUrl2 != ''}">--%>
        <%--, 'uploadUrl': null, 'initialPreview': [--%>
        <%--"<img src='${teamForm.picUrl2}' class='file-preview-image kv-preview-data' stype='width:auto;height:auto;max-width:100%;max-height:100%;' alt='Desert' title='Desert'>"--%>
        <%--]--%>
        <%--</c:if>--%>
    });
